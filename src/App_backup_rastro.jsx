...
const INITIAL_PLAYERS = [
  { id: 1, shirt: "1", name: "Rossi", image: "/players/rossi.png", x: 12, y: 50 },
  { id: 2, shirt: "2", name: "Varela", image: "/players/varela.png", x: 24, y: 82 },
  { id: 3, shirt: "3", name: "Léo Ortiz", image: "/players/leo_ortiz.png", x: 24, y: 38 },
  { id: 4, shirt: "4", name: "Léo Pereira", image: "/players/leo_pereira.png", x: 24, y: 62 },
  { id: 5, shirt: "6", name: "Ayrton Lucas", image: "/players/ayrton_lucas.png", x: 24, y: 18 },
  { id: 6, shirt: "21", name: "Jorginho", image: "/players/jorginho.png", x: 44, y: 38 },
  { id: 7, shirt: "8", name: "Saúl", image: "/players/saul.png", x: 44, y: 62 },
  { id: 8, shirt: "10", name: "Arrascaeta", image: "/players/arrascaeta.png", x: 62, y: 50 },
  { id: 9, shirt: "11", name: "Everton", image: "/players/everton.png", x: 76, y: 18 },
  { id: 10, shirt: "9", name: "Pedro", image: "/players/pedro.png", x: 82, y: 50 },
  { id: 11, shirt: "7", name: "Luiz Araújo", image: "/players/luiz_araujo.png", x: 76, y: 82 },
];
...
const subtitle = branding.slogan;
  ...
  setPlayerTrails((prev) => {
    const currentTrail = prev[playerId] || [];
    const newTrail = [...currentTrail, { x, y }].slice(-40);
  ...
  addTrailPoint(id, clamp(x, 4, 96), clamp(y, 6, 94));
...
onMouseLeave={() => {
  if (draggingPlayer !== null) {
    const releasedId = draggingPlayer;
    setTimeout(() => clearTrail(releasedId), 400);
  }
  ...
  {Object.entries(playerTrails).map(([playerId, trail]) => {
    ...
    return (
      ...
      />
            ...
            {activePlayer && activePlayer.image && (
              <div
                style={{
                  position: "absolute",
                  right: "-8px",
